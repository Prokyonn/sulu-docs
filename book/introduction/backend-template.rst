...
Many of these can be found in this documentation, and we strongly recommend that
you carefully read through and use them as much as possible. By doing so, your
content will be much easier to manage, the performance of your system will be
optimized, and your website will be more easily accessible to users, search
...
As is usual in Symfony, the structure of data is separated from its presentation.
...
how the data is passed to the theme. The **theme** itself is—by default—a set
of **Twig templates**.

We have already heard some content-specific terms on this page. On the next page,
