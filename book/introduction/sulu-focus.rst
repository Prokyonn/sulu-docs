...
Complex structures arise. With Sulu, we build up a data pool that feeds a set of
...
feedback. You can't create ugly content; it will directly get back at you.
...
about how to hack stuff. That's why we chose Symfony as a base. A clean,
modern framework that allows developers to adapt, extend, and modify
functionality wherever they want.

We have learned what Sulu focuses on. Next, we'll show what comes with Sulu in a
basic installation.
