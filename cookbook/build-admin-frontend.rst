...
If not yet installed on your computer, you will need to install `node`_
on your computer.
...
If not yet installed on your computer, you will need to install `bun`_
on your computer.
...
.. warning::
    ...
    Because of a breaking change for linked packages, Sulu is not compatible with npm v7 at the moment. Take a look at the `issue in the sulu/skeleton repository`_ for more information about this.
