...
To activate the webspace within Sulu, you have to clear the cache with the following command:
...
After these few steps, you are able to administrate and view your new webspace.

If you have any errors, you can use the following command to validate your webspace:
