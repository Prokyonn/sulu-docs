...
Displays a map to assign geographic coordinates. To search for coordinates using
an address in the administration interface, you must set up a ``geolocator`` in the
