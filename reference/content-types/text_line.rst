...
Shows a simple text line. The inserted content will be saved as a simple string.
...
.. list-table::
    ...
    * - max_segments
      - string
      - A soft limit for the maximum number of segments. Will show a segment counter.
    * - segment_delimiter
      - string
